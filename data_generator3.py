...
target = np.ndarray(shape = (h,n_unique))
...
np.save('n6J_design.npy', design)
np.save('n6low_target.npy', target_low)
np.save('n6all_target.npy', target_all)
np.save('n6unique_target.npy', target)
